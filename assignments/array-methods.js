...
// for each person in [runners] get first name and last name
// make a string with fname and lname and save it into a new array
// arr.forEach(callback(currentValue) {});

runners.forEach(function(runner){
  // console.log(runner.first_name); testing
...
firstNamesAllCaps = runners.map(function(runner){
  // console.log(runner.first_name.toUpperCase()); testing
  firstNamesAllCaps = runner.first_name.toUpperCase();
